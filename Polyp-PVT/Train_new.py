...
if __name__ == '__main__':
    ...
    train_loader = get_updated_loader(image_root, gt_root, subfolders = subfolders, batchsize=opt.batchsize, trainsize=opt.trainsize,
                              augmentation=opt.augmentation, switch_ratio=opt.switch_ratio, training_type=opt.training_type,
                              align_score_cutoff=opt.align_score_cutoff, max_aug=opt.max_aug, selection_rule=opt.selection_rule, 
                              use_background=opt.use_background)
