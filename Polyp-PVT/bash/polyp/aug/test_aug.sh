...
--train_dataset_name aug_basic \
--save_grid \
--save_res \
--data_path /home/user01/majiajian/data/polyp/ \
--pth_path /home/user01/majiajian/code/segmentation/Polyp-PVT/model_pth/SUN-SEG_Aug_baseline_2024-05-02-19-56-58/9PolypPVT-best.pth