...
export validation_list="/home/user01/majiajian/code/diffusion/diffusers/examples/inpaint/concept_list/0430/validation_list_0430.json"

accelerate launch scripts/polyp/train_inpaint.py \
  --pretrained_model_name_or_path=$MODEL_NAME  \
  --resume_from_checkpoint="latest" \
  --instance_data_dir="/home/user01/majiajian/data/polyp/SUN-SEG_10/TrainDataset_10/images" \
